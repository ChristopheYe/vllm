...
class CUDAGraphRunner:
    ...
    def __init__(self, model: nn.Module, backend_name: str, attn_state: AttentionState):
        self.model = model
    ...
    def forward(
        ...
        **kwargs,
        ...
        self.attn_state.prepare_graph_input_buffers(self.input_buffers, attn_metadata)
